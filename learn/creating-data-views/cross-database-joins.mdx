...
```mermaid
graph TB
    subgraph "Pylar Session"
        DF1[table0<br/>Events Dataframe]
        DF2[table1<br/>Users Dataframe]
        DF3[table2<br/>Sessions Dataframe]
    end
    
    SQL[SQL Query<br/>JOIN on common keys]
    RESULT[Unified Result<br/>Combined View]
    ...
    style SQL fill:#FF4017,stroke:#CC3300,color:#fff
```
