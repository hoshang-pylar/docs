...
<Image
  src="/images/db_view_pylar_docs.png"
  alt="Pylar SQL IDE interface showing datasource selector, query editor, and results panel"
  caption="The SQL IDE interface with datasource selector, query editor, and results panel"
/>
...
<Image
  src="/images/create_view_button.png"
  alt="Create view button and run query button in Pylar SQL IDE"
  caption="Create view and run query buttons in the SQL IDE"
/>
...
<Image
  src="/images/running_db_view.png"
  alt="Query results displayed in Pylar SQL IDE showing data table and execution metadata"
  caption="Query results panel showing data table, row count, and execution details"
/>
