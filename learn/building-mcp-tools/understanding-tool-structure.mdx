...
<Image
  src="/images/mcp_tool_details.png"
  alt="MCP tool details view showing function name, description, SQL query, and parameters"
  caption="MCP tool details interface showing all tool components"
/>
...
<Image
  src="/images/mcp_tool_json_view.png"
  alt="MCP tool JSON structure view showing the complete tool configuration"
  caption="MCP tool JSON structure view showing complete configuration"
/>
