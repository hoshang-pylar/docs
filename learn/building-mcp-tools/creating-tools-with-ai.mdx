...
<Image
  src="/images/ai_mcp_tool_creation.png"
  alt="AI-powered MCP tool creation interface in Pylar showing natural language input and generated tool"
  caption="Creating an MCP tool using Pylar's AI assistant"
/>
