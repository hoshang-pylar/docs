...
<Image
  src="/images/test_mcp_tool.png"
  alt="MCP tool testing interface showing test run button and test parameters"
  caption="MCP tool testing interface with test run functionality"
/>
...
<Image
  src="/images/test_mcp_tool_results.png"
  alt="MCP tool test results showing query execution, returned data, and success status"
  caption="Test results showing executed query, returned data, and execution status"
/>
