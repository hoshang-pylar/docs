...
<Image
  src="/images/mcp_tool_section.png"
  alt="MCP Tools section in Pylar showing available tools and create tool option"
  caption="MCP Tools section in the Pylar interface"
/>
