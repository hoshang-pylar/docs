...
Claude Desktop is Anthropic's desktop AI assistant that supports MCP (Machine-Consumable Protocol) tools. Connect your Pylar tools to Claude Desktop to give Claude access to your data through governed views.
