...
<Image
  src="/images/pylar_frame_show.png"
  alt="Pylar interface showing project view with create view option"
  caption="Pylar project interface with create view option"
/>
