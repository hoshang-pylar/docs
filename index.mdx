...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon="megaphone"
    href="/examples/marketing-campaign-optimizer"
  >
  ...
  <Card
    ...
    icon="chart-bar"
    href="/examples/product-usage-analyst"
  >
  ...
  <Card
    ...
    icon="dollar-sign"
    href="/examples/financial-analyst"
  >
  ...
  <Card
    ...
    icon="server"
    href="/examples/it-operations-monitor"
  >
